...
<div id="container">
	<div class="nav">	
			 <ul>
				...
				<li><a href="product1.php"> 			 <i class="icon-th-list"></i>All Products</a></li>
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				...
				<div class="modal-body">
					<ul>
						<li>You are guaranteed that your bed will be delivered within 2-3 days upon ordering.</li>
						...
						<li>Upon receiving your bed we will charge a delivery fee depending on the location.</li>
					</ul>
				</div>
			<div class="modal-footer">
				<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Close</button>
	...
	<div id="footer">
		<div class="foot">
			...
			<div id="develop">
				<h4>Developed By:</h4>
					<ul>
						<a href="#"><li>Sihle Junior Majola</li><a>
					</ul>
			</div>
	</div>
</body>
