...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="text" name="product_size" placeholder="Size" style="width:250px;" required></td>
							</tr>
							<tr>
		...
		<ul>
			...
			<li><a href="admin_home.php">Products</a>
				<ul>
					...
					<li><a href="admin_product.php "style="font-size:15px; margin-left:15px;">Premium Luxury</a></li>
					<li><a href="admin_football.php" style="font-size:15px; margin-left:15px;">Medium Quality</a></li>
					<li><a href="admin_running.php"style="font-size:15px; margin-left:15px;">Low End</a></li>
				</ul>
			</li>
	...
	<label style="font-size:25px;">AlphaWarehouse CC.</label>
