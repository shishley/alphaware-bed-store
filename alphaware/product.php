...
<div id="container">
	<div class="nav">
			 ...
			 <ul>
				...
				<li><a href="product.php"><i class="icon-th-list"></i>All Products</a>
	...
	<div class="nav1">
		<ul>
			<li><a href="product.php" class="active" style="color:#111;">Premium Luxury</a></li>
			<li>|</li>
			<li><a href="football.php">Medium Quality</a></li>
			<li>|</li>
			<li><a href="running.php">Low End</a></li>
		</ul>
