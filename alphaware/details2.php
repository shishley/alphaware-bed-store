...
<html>
<head>
	<title>AlphaWare Bed Store</title>
...
<div id="container">
	<div class="nav">	
			 <ul>
				...
				<li><a href="product.php"> 			 <i class="icon-th-list"></i>All Products</a></li>
		...
		?>
				<div>
					<center>
						...
						<h3 class="text-uppercase">R <?php echo $row['product_price']?></h3>
		...
		<div id="purchase" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">Choose Payment Type</h3>
			</div>
				<div class="modal-body">
					<form method="post">
					<center>
						...
						<select name="size" required style="width:150px;">
							...
							<option value="11">Sleeper Couch</option>
							<option value="12">Blow Up Matress</option>
						</select>
						<br />
						<h4>Total: R <?php echo $row['product_price']; ?> </h4>
						<br />
						<input type="checkbox" required> I Agree with the <a href="#terms" data-toggle="modal"> Terms and Conditions</a> of AlphaWarehouse CC.
					</center>
				</div>
			<div class="modal-footer">
				<center>
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">AlphaWarehouse CC. Terms and Conditions</h3>
			</div>
				<div class="modal-body">
					<ul>
						<li>You are guaranteed that your product will be delivered within 2-3 days upon ordering.</li>
						<li>Guaranteed time maybe suspended depending on the weather conditions for the safety of our delivery personnel.</li>
						<li>All prices quoted are in South African ZAR Rands. Price and availability information is subject to change without notice.</li>
						<li>Modes of payment are as follows:customers with paypal account can pay through paypal otherwise Cash on Delivery(COD).</li>
						<li>Upon receiving your product we will charge a delivery fee depending on the location.</li>
					</ul>
				</div>
			<div class="modal-footer">
				<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Close</button>
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">Alphawarehouse CC. 2022</p>
		</div>
			
			<div id="foot">
				<h4>Links</h4>
					<ul>
					<a href="http://www.facebook.com/alphawarehouse-bed-store"><li>Facebook</li></a>
						<a href="http://www.twitter.com/alphaware-bed-store"><li>Twitter</li></a>
						<a href="http://www.pinterest.com/alphaware-bed-store"><li>Pinterest</li></a>
						<a href="http://www.tumblr.com/alphawarebedstore"><li>Tumblr</li></a>
					</ul>
			</div>
	</div>
</body>
